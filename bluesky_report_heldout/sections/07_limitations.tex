...
Un limite importante riguarda la validazione predittiva: oltre alle predizioni out-of-fold in cross-validation sul training, l'analisi ora include un test set held-out derivato dallo stesso campione bilanciato, ma non una validazione temporale esterna su mesi successivi. Inoltre, il campionamento bilanciato impone una prevalenza artificiale del 50\%, diversa dalla prevalenza reale dei takedown nella popolazione osservabile.
