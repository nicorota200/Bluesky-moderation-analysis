...
- **Cross-validation vs test set**: nel notebook finale viene creato un test set del 30%, ma le metriche riportate sono ottenute da predizioni out-of-fold sul training set. Il report non le presenta come held-out test performance.
