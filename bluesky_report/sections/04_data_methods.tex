...
La Random Forest e' usata come modello predittivo non causale. L'analisi principale usa il pool massimo con corner 00 escluso, gruppi 0p, p0 e pp bilanciati, \num{28650} osservazioni complessive, \num{14325} positivi e \num{14325} negativi. Il dataset e' diviso in training e test held-out con split stratificato 70/30. Sul training viene mantenuta una validazione \code{StratifiedKFold} a 10 fold con predizioni out-of-fold; dopo questa validazione il modello finale viene addestrato sull'intero training set e valutato separatamente sul test set held-out.
