...
Nel setup principale la Random Forest raggiunge CV F1 medio \num{0.6876} con deviazione standard \num{0.0134}. Le predizioni out-of-fold producono accuracy \num{0.7385}, precision \num{0.8534}, recall \num{0.5760}, F1 \num{0.6878} e ROC AUC \num{0.7604}. La matrice di confusione cross-validata e':
\[
\begin{pmatrix}
9035 & 992\\
4252 & 5776
...
La performance varia tra gruppi esposti (\cref{tab:corner-rf,fig:corner-rf}). Il gruppo pp e' il piu' classificabile, con ROC AUC \num{0.819} e F1 per i positivi \num{0.754}; 0p e p0 mostrano precision elevata ma recall piu' bassa.
...
\begin{figure}[!htbp]
  ...
  \caption{Performance del modello principale per corner esposto.}
  \label{fig:corner-rf}
\end{figure}
